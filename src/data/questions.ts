...
export const questions: Question[] = [
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.3.1 Info and Relationships", url: "https://www.w3.org/WAI/WCAG22/Understanding/info-and-relationships.html" },
      { label: "WCAG 2.2 Understanding: 2.4.6 Headings and Labels", url: "https://www.w3.org/WAI/WCAG22/Understanding/headings-and-labels.html" },
    ],
  },
  {
    id: "struct-002",
    ...
    refs: [
      { label: "ARIA APG: Landmark Regions", url: "https://www.w3.org/WAI/ARIA/apg/practices/landmark-regions/" },
      { label: "WCAG 2.2 Understanding: 1.3.1 Info and Relationships", url: "https://www.w3.org/WAI/WCAG22/Understanding/info-and-relationships.html" },
    ],
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.4.1 Bypass Blocks", url: "https://www.w3.org/WAI/WCAG22/Understanding/bypass-blocks.html" },
    ],
  },
  {
    id: "struct-004",
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 3.3.2 Labels or Instructions", url: "https://www.w3.org/WAI/WCAG22/Understanding/labels-or-instructions.html" },
      { label: "accname 1.2 (Accessible Name Computation)", url: "https://www.w3.org/TR/accname-1.2/" },
    ],
  },
  {
    id: "formlabel-002",
  ...
  },
  {
    ...
    difficulty: "hard",
    question:
      "A button shows the visible text \"Search\" but is coded as <button aria-label=\"Submit search query\">Search</button>. A speech-input user says \"Click Search\" and nothing happens. Which statement best identifies the conformance problem?",
    options: [
      "This fails Name, Role, Value because a button is not allowed to have both visible text and an aria-label.",
      "This fails Label in Name because the accessible name (\"Submit search query\") does not contain the visible label text \"Search\".",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.5.3 Label in Name", url: "https://www.w3.org/WAI/WCAG22/Understanding/label-in-name.html" },
      { label: "accname 1.2 (Accessible Name Computation)", url: "https://www.w3.org/TR/accname-1.2/" },
    ],
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 3.3.3 Error Suggestion", url: "https://www.w3.org/WAI/WCAG22/Understanding/error-suggestion.html" },
    ],
  },
  {
    id: "formerr-002",
    ...
    refs: [
      { label: "WAI-ARIA 1.2: aria-invalid and aria-describedby", url: "https://www.w3.org/TR/wai-aria-1.2/" },
      { label: "WCAG 2.2 Understanding: 3.3.1 Error Identification", url: "https://www.w3.org/WAI/WCAG22/Understanding/error-identification.html" },
    ],
  },
  {
    id: "formerr-003",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 3.3.8 Accessible Authentication (Minimum)", url: "https://www.w3.org/WAI/WCAG22/Understanding/accessible-authentication-minimum.html" },
    ],
  },
  {
    id: "formerr-004",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 3.3.7 Redundant Entry", url: "https://www.w3.org/WAI/WCAG22/Understanding/redundant-entry.html" },
    ],
  },
  {
    id: "formerr-005",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 3.3.4 Error Prevention (Legal, Financial, Data)", url: "https://www.w3.org/WAI/WCAG22/Understanding/error-prevention-legal-financial-data.html" },
    ],
  },
  {
    id: "img-001",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.1.1 Non-text Content", url: "https://www.w3.org/WAI/WCAG22/Understanding/non-text-content.html" },
    ],
  },
  {
    id: "img-002",
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.11 Non-text Contrast", url: "https://www.w3.org/WAI/WCAG22/Understanding/non-text-contrast.html" },
    ],
  },
  {
    id: "img-004",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.5 Images of Text", url: "https://www.w3.org/WAI/WCAG22/Understanding/images-of-text.html" },
    ],
  },
  {
    id: "media-001",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.2.2 Captions (Prerecorded)", url: "https://www.w3.org/WAI/WCAG22/Understanding/captions-prerecorded.html" },
    ],
  },
  {
    id: "media-002",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.2.5 Audio Description (Prerecorded)", url: "https://www.w3.org/WAI/WCAG22/Understanding/audio-description-prerecorded.html" },
      { label: "WCAG 2.2 Understanding: 1.2.3 Audio Description or Media Alternative (Prerecorded)", url: "https://www.w3.org/WAI/WCAG22/Understanding/audio-description-or-media-alternative-prerecorded.html" },
    ],
  },
  {
    id: "media-003",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.2 Audio Control", url: "https://www.w3.org/WAI/WCAG22/Understanding/audio-control.html" },
    ],
  },
  {
    id: "media-004",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.2.4 Captions (Live)", url: "https://www.w3.org/WAI/WCAG22/Understanding/captions-live.html" },
    ],
  },
  {
    id: "kbd-001",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.4.7 Focus Visible", url: "https://www.w3.org/WAI/WCAG22/Understanding/focus-visible.html" },
    ],
  },
  {
    id: "kbd-003",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.1.2 No Keyboard Trap", url: "https://www.w3.org/WAI/WCAG22/Understanding/no-keyboard-trap.html" },
    ],
  },
  {
    id: "kbd-005",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.4.11 Focus Not Obscured (Minimum)", url: "https://www.w3.org/WAI/WCAG22/Understanding/focus-not-obscured-minimum.html" },
      { label: "WCAG 2.2 Understanding: 2.4.12 Focus Not Obscured (Enhanced)", url: "https://www.w3.org/WAI/WCAG22/Understanding/focus-not-obscured-enhanced.html" },
    ],
  },
  {
    id: "kbd-006",
    ...
    refs: [
      ...
      { label: "WCAG 2.2 Understanding: 2.4.3 Focus Order", url: "https://www.w3.org/WAI/WCAG22/Understanding/focus-order.html" },
    ],
  },
  {
    id: "focus-001",
    ...
    refs: [
      { label: "ARIA APG: Dialog (Modal) Pattern", url: "https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/" },
      { label: "WCAG 2.2 Understanding: 2.4.3 Focus Order", url: "https://www.w3.org/WAI/WCAG22/Understanding/focus-order.html" },
    ],
  },
  {
  ...
  },
  {
    ...
    refs: [
      { label: "ARIA APG: Developing a Keyboard Interface", url: "https://www.w3.org/WAI/ARIA/apg/practices/keyboard-interface/" },
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 3.2.1 On Focus", url: "https://www.w3.org/WAI/WCAG22/Understanding/on-focus.html" },
      { label: "WCAG 2.2 Understanding: 3.2.2 On Input", url: "https://www.w3.org/WAI/WCAG22/Understanding/on-input.html" },
    ],
  },
  {
    id: "ariaw-001",
    ...
    refs: [
      { label: "ARIA APG: Tabs Pattern", url: "https://www.w3.org/WAI/ARIA/apg/patterns/tabs/" },
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
    ],
  },
  {
    id: "ariaw-002",
    ...
    refs: [
      { label: "ARIA APG: Disclosure Pattern", url: "https://www.w3.org/WAI/ARIA/apg/patterns/disclosure/" },
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
    ],
  },
  {
    ...
    refs: [
      { label: "ARIA APG: Tabs Pattern (keyboard interaction)", url: "https://www.w3.org/WAI/ARIA/apg/patterns/tabs/" },
      { label: "WCAG 2.2 Understanding: 2.1.1 Keyboard", url: "https://www.w3.org/WAI/WCAG22/Understanding/keyboard.html" },
    ],
  },
  {
    id: "ariaw-004",
  ...
  },
  {
    ...
    refs: [
      { label: "ARIA APG: Combobox Pattern", url: "https://www.w3.org/WAI/ARIA/apg/patterns/combobox/" },
  ...
  },
  {
    ...
    refs: [
      { label: "ARIA APG: Switch Pattern", url: "https://www.w3.org/WAI/ARIA/apg/patterns/switch/" },
      { label: "WAI-ARIA 1.2 specification", url: "https://www.w3.org/TR/wai-aria-1.2/" },
    ],
  },
  {
    ...
    refs: [
      { label: "ARIA APG: Slider Pattern", url: "https://www.w3.org/WAI/ARIA/apg/patterns/slider/" },
      { label: "WAI-ARIA 1.2 specification", url: "https://www.w3.org/TR/wai-aria-1.2/" },
    ],
  },
  {
    ...
    refs: [
      { label: "WAI-ARIA 1.2: aria-hidden state", url: "https://www.w3.org/TR/wai-aria-1.2/#aria-hidden" },
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
    ],
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 4.1.3 Status Messages", url: "https://www.w3.org/WAI/WCAG22/Understanding/status-messages.html" },
      { label: "WAI-ARIA 1.2 specification", url: "https://www.w3.org/TR/wai-aria-1.2/" },
    ],
  },
  {
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.3 Contrast (Minimum)", url: "https://www.w3.org/WAI/WCAG22/Understanding/contrast-minimum.html" },
    ],
  },
  {
    id: "color-002",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.1 Use of Color", url: "https://www.w3.org/WAI/WCAG22/Understanding/use-of-color.html" },
    ],
  },
  {
    id: "color-003",
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.6 Contrast (Enhanced)", url: "https://www.w3.org/WAI/WCAG22/Understanding/contrast-enhanced.html" },
    ],
  },
  {
    id: "adapt-001",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.10 Reflow", url: "https://www.w3.org/WAI/WCAG22/Understanding/reflow.html" },
    ],
  },
  {
    id: "adapt-002",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.12 Text Spacing", url: "https://www.w3.org/WAI/WCAG22/Understanding/text-spacing.html" },
    ],
  },
  {
    id: "adapt-003",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.5.8 Target Size (Minimum)", url: "https://www.w3.org/WAI/WCAG22/Understanding/target-size-minimum.html" },
    ],
  },
  {
    id: "adapt-004",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 1.4.13 Content on Hover or Focus", url: "https://www.w3.org/WAI/WCAG22/Understanding/content-on-hover-or-focus.html" },
    ],
  },
  {
    id: "input-001",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.5.1 Pointer Gestures", url: "https://www.w3.org/WAI/WCAG22/Understanding/pointer-gestures.html" },
    ],
  },
  {
    id: "input-002",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.5.4 Motion Actuation", url: "https://www.w3.org/WAI/WCAG22/Understanding/motion-actuation.html" },
    ],
  },
  {
    id: "input-003",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.2.2 Pause, Stop, Hide", url: "https://www.w3.org/WAI/WCAG22/Understanding/pause-stop-hide.html" },
    ],
  },
  {
    id: "input-004",
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.5.2 Pointer Cancellation", url: "https://www.w3.org/WAI/WCAG22/Understanding/pointer-cancellation.html" },
    ],
  },
  {
    id: "accname-001",
    ...
    refs: [
      { label: "Accessible Name and Description Computation 1.2", url: "https://www.w3.org/TR/accname-1.2/" },
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
    ],
  },
  {
  ...
  },
  {
    ...
    difficulty: "hard",
    question:
      "A button shows the visible text \"Play\" but is coded as <button aria-label=\"Start playback now\">Play</button>. A user who relies on speech input says \"Play\" to activate it, but nothing happens. Which evaluation conclusion is correct?",
    options: [
      "It fails 2.5.3 Label in Name (Level A) because the visible label text \"Play\" is not contained within the accessible name \"Start playback now\"",
      "It passes 2.5.3 Label in Name because the accessible name is more descriptive than the visible label",
      "It fails 4.1.2 Name, Role, Value (Level A) because a button must not have both visible content and an aria-label",
      "It passes all relevant criteria because aria-label always takes precedence over the visible text",
    ],
    correctIndex: 0,
    explanation:
      "2.5.3 Label in Name (Level A) requires that the visible label text be contained within the accessible name, so speech users can activate the control by speaking what they see; here aria-label replaces \"Play\" with \"Start playback now\", which does not contain \"Play\", so it fails. The element is technically named and has a role, so the 4.1.2 framing about forbidding both content and aria-label is incorrect.",
    refs: [
      { label: "WCAG 2.2 Understanding: 2.5.3 Label in Name", url: "https://www.w3.org/WAI/WCAG22/Understanding/label-in-name.html" },
      { label: "Accessible Name and Description Computation 1.2", url: "https://www.w3.org/TR/accname-1.2/" },
    ],
  },
  {
    ...
    refs: [
      { label: "WCAG-EM: Website Accessibility Conformance Evaluation Methodology", url: "https://www.w3.org/TR/WCAG-EM/" },
    ],
  },
  {
    id: "evalm-002",
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG-EM Step 1: Define the Evaluation Scope", url: "https://www.w3.org/TR/WCAG-EM/" },
    ],
  },
  {
    id: "evalm-004",
    ...
    refs: [
      { label: "WCAG-EM Step 3: Select a Representative Sample", url: "https://www.w3.org/TR/WCAG-EM/" },
    ],
  },
  {
    id: "evalm-006",
    ...
    refs: [
      { label: "WCAG-EM Step 2: Explore the Target Website", url: "https://www.w3.org/TR/WCAG-EM/" },
    ],
  },
  {
    id: "conf-001",
    ...
    refs: [
      { label: "WCAG 2.2: Conformance Requirements", url: "https://www.w3.org/TR/WCAG22/#conformance" },
    ],
  },
  {
    id: "conf-002",
    ...
    refs: [
      { label: "WCAG 2.2: Conformance Requirement 2 (Full pages)", url: "https://www.w3.org/TR/WCAG22/#cc2" },
    ],
  },
  {
    id: "conf-003",
    ...
    refs: [
      { label: "WCAG 2.2: Conformance Requirement 3 (Complete processes)", url: "https://www.w3.org/TR/WCAG22/#cc3" },
    ],
  },
  {
    id: "conf-004",
    ...
    refs: [
      { label: "WCAG 2.2: Conformance Requirement 4 (accessibility-supported ways)", url: "https://www.w3.org/TR/WCAG22/#cc4" },
      { label: "WCAG 2.2: Understanding Accessibility Support", url: "https://www.w3.org/WAI/WCAG22/Understanding/conformance.html" },
    ],
  },
  {
    id: "conf-005",
    ...
    refs: [
      { label: "WCAG 2.2: Conformance Requirement 5 (Non-interference)", url: "https://www.w3.org/TR/WCAG22/#cc5" },
    ],
  },
  {
    id: "conf-006",
    ...
    refs: [
      { label: "WCAG 2.2: Required Components of a Conformance Claim", url: "https://www.w3.org/TR/WCAG22/#conformance-claims" },
    ],
  },
  {
    id: "conf-007",
    ...
    refs: [
      { label: "WCAG 2.2: Conformance (full pages) and Statement of Partial Conformance", url: "https://www.w3.org/TR/WCAG22/#conformance" },
    ],
  },
  {
    id: "act-001",
    ...
    refs: [
      { label: "ACT Rules Format 1.1: Atomic and Composite Rules", url: "https://www.w3.org/TR/act-rules-format-1.1/" },
    ],
  },
  {
    id: "act-002",
    ...
    refs: [
      { label: "ACT Rules Format 1.1: Rule structure (Applicability and Expectations)", url: "https://www.w3.org/TR/act-rules-format-1.1/" },
    ],
  },
  {
    id: "act-003",
    ...
    refs: [
      { label: "ACT Rules Format 1.1: Outcome (inapplicable vs passed)", url: "https://www.w3.org/TR/act-rules-format-1.1/" },
    ],
  },
  {
    id: "act-004",
    ...
    refs: [
      { label: "ACT Rules Format 1.1: Outcome (cantTell and untested)", url: "https://www.w3.org/TR/act-rules-format-1.1/" },
    ],
  },
  {
    id: "act-005",
    ...
    refs: [
      { label: "ACT Rules Format 1.1: Purpose and scope", url: "https://www.w3.org/TR/act-rules-format-1.1/" },
      { label: "W3C WAI ACT Rules library (informative test rules)", url: "https://www.w3.org/WAI/standards-guidelines/act/rules/" },
    ],
  },
  {
    id: "tool-001",
  ...
  },
  {
    ...
    refs: [
      { label: "ACT Rules Format 1.1", url: "https://www.w3.org/TR/act-rules-format-1.1/" },
      { label: "ACT Rules Library (W3C WAI)", url: "https://www.w3.org/WAI/standards-guidelines/act/rules/" },
    ],
  },
  {
    id: "sr-001",
    ...
    refs: [
      { label: "Deque University: NVDA Keyboard Shortcuts (browse vs focus mode, quick navigation)", url: "https://dequeuniversity.com/screenreaders/nvda-keyboard-shortcuts" },
      { label: "Deque University: JAWS Keyboard Shortcuts (browse vs forms mode, quick navigation)", url: "https://dequeuniversity.com/screenreaders/jaws-keyboard-shortcuts" },
    ],
  },
  {
    id: "sr-002",
  ...
  },
  {
    ...
    refs: [
      { label: "ARIA 1.2: Accessibility Tree", url: "https://www.w3.org/TR/wai-aria-1.2/#accessibility_tree" },
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
    ],
  },
  {
    ...
    refs: [
      { label: "ARIA 1.2: aria-hidden state", url: "https://www.w3.org/TR/wai-aria-1.2/#aria-hidden" },
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
    ],
  },
  {
    ...
    refs: [
      { label: "Core-AAM 1.2: User Agent and Accessibility API Mappings", url: "https://www.w3.org/TR/core-aam-1.2/" },
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
    ],
  },
  {
    ...
    refs: [
      { label: "MDN: ARIA presentation role", url: "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/presentation_role" },
    ],
  },
  {
    id: "vioa-001",
    ...
    refs: [
      { label: "ARIA APG: Disclosure (Show/Hide) Pattern", url: "https://www.w3.org/WAI/ARIA/apg/patterns/disclosure/" },
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
    ],
  },
  {
    ...
    refs: [
      { label: "ARIA 1.2: aria-label and prohibited roles", url: "https://www.w3.org/TR/wai-aria-1.2/#aria-label" },
      { label: "accname 1.2 (Accessible Name Computation)", url: "https://www.w3.org/TR/accname-1.2/" },
    ],
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.1.1 Keyboard", url: "https://www.w3.org/WAI/WCAG22/Understanding/keyboard.html" },
      { label: "ARIA APG: Button Pattern", url: "https://www.w3.org/WAI/ARIA/apg/patterns/button/" },
    ],
  },
  {
    id: "vioa-004",
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 4.1.2 Name, Role, Value", url: "https://www.w3.org/WAI/WCAG22/Understanding/name-role-value.html" },
      { label: "MDN: aria-hidden attribute", url: "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-hidden" },
    ],
  },
  {
    id: "vioa-006",
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2 Understanding: 2.4.4 Link Purpose (In Context)", url: "https://www.w3.org/WAI/WCAG22/Understanding/link-purpose-in-context.html" },
      { label: "WCAG 2.2 Understanding: 3.2.4 Consistent Identification", url: "https://www.w3.org/WAI/WCAG22/Understanding/consistent-identification.html" },
    ],
  },
  {
    id: "viob-003",
  ...
  },
  {
    ...
    refs: [
      { label: "How to Create an ACR Using a VPAT (Section508.gov, conformance term definitions)", url: "https://www.section508.gov/sell/how-to-create-acr-with-vpat/" },
      { label: "VPAT (ITI Information Technology Industry Council)", url: "https://www.itic.org/policy/accessibility/vpat" },
    ],
  },
  {
    id: "vpatterm-002",
    ...
    refs: [
      { label: "How to Create an ACR with a VPAT (Section 508)", url: "https://www.section508.gov/sell/how-to-create-acr-with-vpat/" },
      { label: "WCAG 2.2 Conformance", url: "https://www.w3.org/TR/WCAG22/#conformance" },
    ],
  },
  {
    ...
    refs: [
      { label: "VPAT (ITI) conformance terms", url: "https://www.itic.org/policy/accessibility/vpat" },
      { label: "Accessibility Conformance Report (ACR)", url: "https://www.section508.gov/sell/acr/" },
    ],
  },
  {
    id: "vpatterm-004",
    ...
    refs: [
      { label: "VPAT (ITI) conformance terms", url: "https://www.itic.org/policy/accessibility/vpat" },
      { label: "WCAG 2.2 Understanding: 1.2.1 Audio-only and Video-only (Prerecorded)", url: "https://www.w3.org/WAI/WCAG22/Understanding/audio-only-and-video-only-prerecorded.html" },
    ],
  },
  {
    id: "vpatterm-005",
    ...
    refs: [
      { label: "Section508.gov: How to create an ACR using a VPAT (conformance term definitions including equivalent facilitation)", url: "https://www.section508.gov/sell/how-to-create-acr-with-vpat/" },
      { label: "WCAG 2.2 Understanding: 3.3.2 Labels or Instructions", url: "https://www.w3.org/WAI/WCAG22/Understanding/labels-or-instructions.html" },
    ],
  },
  {
    ...
    refs: [
      { label: "ITI: VPAT (Voluntary Product Accessibility Template)", url: "https://www.itic.org/policy/accessibility/vpat" },
      { label: "Section508.gov: Accessibility Conformance Reports (ACR)", url: "https://www.section508.gov/sell/acr/" },
    ],
  },
  {
    id: "vpated-003",
  ...
  },
  {
    ...
    refs: [
      { label: "ATAG 2.0 (W3C Recommendation)", url: "https://www.w3.org/TR/ATAG20/" },
    ],
  },
  {
    id: "atag-002",
    ...
    refs: [
      { label: "ATAG 2.0: authoring tool definition", url: "https://www.w3.org/TR/ATAG20/" },
    ],
  },
  {
    id: "atag-003",
    ...
    refs: [
      { label: "ATAG 2.0: Part B principles", url: "https://www.w3.org/TR/ATAG20/" },
    ],
  },
  {
    id: "atag-004",
    ...
    refs: [
      { label: "ATAG 2.0: Principle B.2", url: "https://www.w3.org/TR/ATAG20/" },
    ],
  },
  {
    id: "atag-005",
    ...
    refs: [
      { label: "ATAG 2.0: conformance and Part B.3", url: "https://www.w3.org/TR/ATAG20/" },
    ],
  },
  {
    id: "std-001",
    ...
    refs: [
      { label: "W3C: EU Web Accessibility laws (EN 301 549 includes WCAG 2.1 Level AA for web content)", url: "https://www.w3.org/WAI/policies/european-union/" },
      { label: "EU: Web Accessibility Directive standards and harmonisation", url: "https://digital-strategy.ec.europa.eu/en/policies/web-accessibility-directive-standards-and-harmonisation" },
    ],
  },
  {
    id: "std-002",
    ...
    refs: [
      { label: "U.S. Access Board: Revised Section 508 ICT Standards (WCAG 2.0 A/AA)", url: "https://www.access-board.gov/ict/" },
      { label: "WAI: WCAG 2.1 adopted into EN 301 549", url: "https://www.w3.org/WAI/news/2018-09-13/WCAG-21-EN301549/" },
    ],
  },
  {
    id: "std-003",
    ...
    refs: [
      { label: "WCAG2ICT (Working Group Note)", url: "https://www.w3.org/TR/wcag2ict-22/" },
    ],
  },
  {
    id: "std-004",
    ...
    refs: [
      { label: "ITI VPAT (Voluntary Product Accessibility Template)", url: "https://www.itic.org/policy/accessibility/vpat" },
      { label: "Section 508 / Accessibility Conformance Report", url: "https://www.section508.gov/sell/acr/" },
    ],
  },
  {
    id: "std-005",
    ...
    refs: [
      { label: "Section 508 ACR/VPAT FAQ (conformance terms)", url: "https://www.section508.gov/sell/acr-vpat-faq/" },
      { label: "ITI VPAT (Voluntary Product Accessibility Template)", url: "https://www.itic.org/policy/accessibility/vpat" },
    ],
  },
  {
  ...
  },
  {
    ...
    refs: [
      { label: "WCAG 2.2: Conformance Requirements", url: "https://www.w3.org/TR/WCAG22/#conformance" },
      { label: "WCAG 2.2 Understanding: Conformance", url: "https://www.w3.org/WAI/WCAG22/Understanding/conformance.html" },
    ],
  },
];
