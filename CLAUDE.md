...
1. Core loop: render a question, select an option, check, show correct/incorrect with the
   explanation and doc links, advance. Persist the run in localStorage.
2. Score panel ("Your run").
3. Theme toggle (default to system, remember choice).
4. Report-a-problem modal and How-it-works modal.
5. Share card.
